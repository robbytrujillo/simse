              ...
              <table class="table table-striped table-bordered zero-configuration" id="kurikulum-table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>2021/2022</td>
                    <td>Kurikulum untuk tahun akademik 2021/2022</td>
                    <td>
                      <div class="d-flex justify-content-start align-items-center">
                        ...
                        <a href="#" class="btn btn-bg-gradient-x-red-pink btn-sm mx-1 delete-kurikulum" 
                  ...
                  <tr>
                    ...
                    <td>2022/2023</td>
                    <td>Kurikulum untuk tahun akademik 2022/2023</td>
                    <td>
                      <div class="d-flex justify-content-start align-items-center">
                        <a href="#" class="btn btn-sm btn-success text-white edit-modal mr-2" data-toggle="modal"
                          data-target="#kurikulum_edit_modal" title="Ubah Kurikulum">
