...
<section id="configuration">
  <div class="content-header row">
    <div class="mb-2 content-header-left col-md-4 col-12">
      <h3 class="content-header-title">Sanction Types Data</h3>
    </div>
      ...
      <div class="breadcrumbs-top float-md-right">
        <div class="mr-1 breadcrumb-wrapper">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Sanction Types</li>
          </ol>
        </div>
      </div>
    </div>
      ...
      <div class="card">
        <div class="card-header">
          <a href="#" data-toggle="modal" data-target="#sanction_type_create_modal"
            ...
            <i class="ft-plus"></i> Add Sanction Type
          </a>
              ...
              <table class="table table-striped table-bordered zero-configuration" id="sanction-type-table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $sanctionType->description ?? 'No Description' }}</td>
                    <td>
                      <div class="d-flex justify-content-start align-items-center">
                        <a href="#" data-id="{{ $sanctionType->id }}"
                          class="mr-2 text-white btn btn-sm btn-success edit-modal" data-toggle="modal"
                          data-target="#sanction_type_edit_modal" title="Edit Sanction Type">
                          <i class="ft-edit"></i>
                        </a>
                        <a href="#" class="mx-1 btn btn-bg-gradient-x-red-pink btn-sm delete-sanction-type" data-id="{{ $sanctionType->id }}"
                          data-toggle="modal" data-target="#delete_sanction_type_modal" title="Delete">
                          <i class="ft-delete"></i>
                        </a>
                      </div>
                    </td>
