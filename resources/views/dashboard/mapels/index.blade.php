...
<section id="configuration">
  <div class="content-header row">
    <div class="content-header-left col-md-4 col-12 mb-2">
      <h3 class="content-header-title">Data Mata Pelajaran</h3>
    </div>
      ...
      <div class="card">
        <div class="card-header">
          <a href="#" data-toggle="modal" data-target="#mapel_create_modal"
            ...
            <i class="ft-plus"></i> Tambah Mata Pelajaran
          </a>
...
@push('modal')
@include('dashboard.mapels.modal.create')
@include('dashboard.mapels.modal.edit')
@include('dashboard.mapels.modal.delete')
@endpush

@push('js')
@include('dashboard.mapels._script')
@endpush
