              ...
              <table class="table table-striped table-bordered zero-configuration" id="violation-type-table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $violationType->description ?? 'Tidak Ada Deskripsi' }}</td>
                    <td>
                      <div class="d-flex justify-content-start align-items-center">
                        <a href="#" data-id="{{ $violationType->id }}"
                        ...
                        <a href="#" class="mx-1 btn btn-bg-gradient-x-red-pink btn-sm delete-violation-type" data-id="{{ $violationType->id }}"
