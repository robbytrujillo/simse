              ...
              <table class="table table-striped table-bordered zero-configuration" id="achievement-award-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>1</td>
                    <td>Award Terbaik</td>
                    <td>Penghargaan untuk pencapaian terbaik tahun ini.</td>
                    <td>
                      <div class="d-flex justify-content-start align-items-center">
                        <a href="#" class="btn btn-sm btn-success text-white edit-modal mr-2" 
                          data-toggle="modal" data-target="#achievement_award_edit_modal" title="Ubah Award Pencapaian">
                          <i class="ft-edit"></i>
                        </a>
                        <a href="#" class="btn btn-bg-gradient-x-red-pink btn-sm mx-1 delete-achievement-award" 
                  ...
                  <tr>
                    <td>2</td>
                    <td>Award Kreatif</td>
                    <td>Penghargaan untuk pencapaian kreatif.</td>
                    <td>
                      <div class="d-flex justify-content-start align-items-center">
                        <a href="#" class="btn btn-sm btn-success text-white edit-modal mr-2" 
                          data-toggle="modal" data-target="#achievement_award_edit_modal" title="Ubah Award Pencapaian">
