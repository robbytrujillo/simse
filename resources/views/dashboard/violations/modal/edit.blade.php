    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="#" method="POST" enctype="multipart/form-data" id="editViolationForm">
                    <!-- CSRF and Method fields removed -->
                    <div class="form-group">
                        ...
                        <select class="form-control" name="violation_type_id" id="edit_violation_type" required>
                            <option value="1" selected>Jenis Pelanggaran 1</option>
                            <option value="2">Jenis Pelanggaran 2</option>
                            <option value="3">Jenis Pelanggaran 3</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="description">Deskripsi Pelanggaran</label>
                        <textarea class="form-control" name="description" id="edit_description" rows="3" required>Deskripsi pelanggaran statis</textarea>
                    </div>
                    <div class="form-group">
                        <label for="date">Tanggal Pelanggaran</label>
                        <input type="date" class="form-control" name="date" id="edit_date" value="2024-01-01" required>
                    </div>
                    <div class="form-group">
                        <label for="penalty">Sanksi</label>
                        <select class="form-control" name="sanction_type_id" id="edit_penalty" required>
                            <option value="1" selected>Sanksi 1</option>
                            <option value="2">Sanksi 2</option>
                            <option value="3">Sanksi 3</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="student_id">Siswa</label>
                        <select class="form-control" name="student_id" id="edit_student_id" required>
                            <option value="1" selected>Siswa 1</option>
                    ...
                    <img id="image_preview" src="https://via.placeholder.com/100" alt="Image Preview" class="mt-2" style="max-width: 100px;">
