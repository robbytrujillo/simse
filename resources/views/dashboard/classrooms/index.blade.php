        ...
        <div class="card-content collapse show">
          <div class="card-body card-dashboard">
            ...
            <div class="table-responsive">
              <table class="table table-striped table-bordered zero-configuration" id="classroom-table">
                <thead>
                  <tr>
                    <th>No</th>
                    <th>Nama Kelas</th>
...
@push('modal')
@include('dashboard.classrooms.modal.create')
@include('dashboard.classrooms.modal.edit')
@include('dashboard.classrooms.modal.delete')
@endpush
@push('js')
@include('dashboard.classrooms._script')
@endpush
@endsection
